...
<div class="container-fluid border rounded pb-1 bg-dark text-white">
    <div class="row">
        ...
        <div class="col-auto me-auto">
            <div class="row">
                <span class="fw-bolder fs-4 p-0">Kárdex</span>
            </div>
            <nav class="row" aria-label="breadcrumb">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active text-white" aria-current="page">Kárdex</li>
                </ol>
            </nav>
        </div>

        <div class="col-auto align-self-center">
            <button type="button" class="btn btn-primary btn-sm" id="btn_kardex">
...
<form class="container-fluid bg-white border rounded mt-3" action="" id="form_invini">
    ...
    <div class="row justify-content-evenly mt-2">
        ...
        <div class="col-md row-sm mt-0 input-group input-group-sm">
            <span class="input-group-text bg-warning" id="v1">Producto:</span>
        ...
        <div class="col-md row-sm input-group input-group-sm">
            <span class="input-group-text bg-warning obligatorio2" id="v2">Almacén:</span>
